...
public class SlotForRegNumberCommandExecutor extends CommandExecutor {
	...
	public SlotForRegNumberCommandExecutor(final ParkingLotService parkingLotService,
	...
	public void execute(final Command command) {
		...
		final Optional<Slot> foundSlot = occupiedSlots.stream()
				.filter(slot -> slot.getParkedCar().getRegistrationNumber().equals(regNumberToFind)).findFirst();
