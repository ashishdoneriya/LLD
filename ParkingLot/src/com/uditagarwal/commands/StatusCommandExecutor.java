 ...
 * It gives which slot has which car. Car details will have both its
 * registration number and its color.
 */
	...
	public void execute(Command command) {
		...
		for (Slot slot : occupiedSlots) {
			...
			outputPrinter.printWithNewLine(
					padString(slotNumber, 12) + padString(parkedCar.getRegistrationNumber(), 19) + parkedCar.getColor());
		}
	}
