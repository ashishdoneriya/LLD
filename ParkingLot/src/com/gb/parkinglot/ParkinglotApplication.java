...
import com.gb.parkinglot.model.parking.CarParkingSpot;
import com.gb.parkinglot.model.parking.EntrancePanel;
import com.gb.parkinglot.model.parking.ExitPanel;
import com.gb.parkinglot.model.parking.MotorBikeParkingSpot;
...
import com.gb.parkinglot.model.parking.Payment;
import com.gb.parkinglot.model.vehicle.Car;
import com.gb.parkinglot.model.vehicle.MotorBike;
...
public class ParkinglotApplication {
	public static void main(String[] args) throws InvlaidParkingFloorException {
		...
		System.out.println(
				ParkingLot.INSTANCE.getParkingFloors().get(0).getFreeParkingSpots().get(ParkingSpotType.CAR).size());

		// Test case 19 - Payment
		Payment payment = new Payment(UUID.randomUUID().toString(), parkingTicket1.getTicketNumber(),
				parkingTicket1.getCharges());
		payment.makePayment();
