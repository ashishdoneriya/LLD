...
public class Case3Tests extends BaseTest {
	...
	void testCase3() {
		...
		ImmutableList<String> u1SelectedSeats = ImmutableList.of(screen1SeatIds.get(0), screen1SeatIds.get(2),
				screen1SeatIds.get(5), screen1SeatIds.get(10));

		ImmutableList<String> u2SelectedSeats = ImmutableList.of(screen1SeatIds.get(0), screen1SeatIds.get(1),
				screen1SeatIds.get(2), screen1SeatIds.get(3));
