...
import com.uditagarwal.api.BookingController;
import com.uditagarwal.api.MovieController;
import com.uditagarwal.api.PaymentsController;
import com.uditagarwal.api.ShowController;
import com.uditagarwal.api.TheatreController;
...
public class BaseTest {
	...
	protected void setupControllers(int lockTimeout, int allowedRetries) {
		...
		final SeatAvailabilityService seatAvailabilityService = new SeatAvailabilityService(bookingService,
				seatLockProvider);
	...
	protected List<String> createSeats(TheatreController theatreController, String screen, int numRows,
			int numSeatsInRow) {
